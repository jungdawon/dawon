...
$(document).ready(function () {
    ...
    {	
    	title:'파이 차트 테스트',	//차트 제목
    	seriesColors: ["red", "yellow", "green"],	//차트 색상 지정 
        seriesDefaults: {
            // Make this a pie chart.
            renderer: jQuery.jqplot.PieRenderer,	//원형 상단에 값 보여주기(알아서 %형으로 변환)
            rendererOptions: {
            	showDataLabels: true,		//파이 차트 내 데이터 보임 유무 설정
            	fill: true,				//파이차트 색상 라인만 남기고 안보임(false)
            	sliceMargin: 5,				//차트사이의 간격
            	shadow: true,				//파이 차트 간격 사이의 그림자
            	lineWidth: 5,				//파이차트 선두께 fill=fasle일때 주로사용
            	padding: 56,				//차트 크기 
        ...
        legend: {
	        	show: true,
	        	border: true, 
	        	location: 'e',	//범레의 위치 e=오른쪽, s=아래, w=왼쪽
	        	//border: 'none',	//범례 외각선 표시
	        	rendererOptions: {
	                numberRows: 3
	            },//범례 표시 줄(line) 갯수
        ...
        grid: {
        		...
        		shadow:true,						//그리드의 그림자 표시
        		drawBorder: true,				//그리드 외각 border 설정
        		//borderWidth:0,
